...
var FHIR = __importStar(require("@johnbendi/fhirclient"));
...
var SmartLaunchHandler = /** @class */ (function () {
    function SmartLaunchHandler(clientID, clientSecret, emrType) {
     ...
     */
    SmartLaunchHandler.prototype.setEMRType = function (emrType) {
        this.emrType = emrType;
    };
    SmartLaunchHandler.prototype.launchEMR = function (redirect, iss, launchType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                emrSpecificScopes = getEmrSpecificScopes(this.emrType, launchType);
                scope = __spreadArray(__spreadArray([], defaultScopes, true), emrSpecificScopes, true).join(" ");
                emrSpecificAuthorizeParams = getEMRSpecificAuthorizeParams(this.emrType);
    ...
    SmartLaunchHandler.prototype.executeWebLaunch = function (launchType, redirectPath) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var queryString, origin, redirect, urlParams, iss;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.launchEMR(redirect, iss, launchType)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
...
function getEmrSpecificScopes(emrType, launchType) {
    ...
    switch (emrType) {
        ...
        case EMR.MEDPLUM:
            return __spreadArray(__spreadArray([], standardScopes, true), [
                "user/*.*",
                "profile",
                "email",
                "offline_access",
        ...
        case EMR.SMART:
            return [
                launchType === ClientFactory_1.LAUNCH.STANDALONE ? "launch/patient" : "launch",
                launchType === ClientFactory_1.LAUNCH.STANDALONE ? "patient/*.*" : "",
                "user/*.*",
                "offline_access",
                "profile",
            ];
