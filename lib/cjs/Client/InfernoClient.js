 ...
 */
var InfernoClient = /** @class */ (function (_super) {
    __extends(InfernoClient, _super);
    /**
     * Creates an instance of InfernoClient.
     * @param {SubClient} fhirClientDefault - The default FHIR client to use.
     */
    function InfernoClient(fhirClientDefault) {
        var _this = _super.call(this, fhirClientDefault) || this;
        _this.EMR_TYPE = SmartLaunchHandler_1.EMR.INFERNO;
        return _this;
    }
    InfernoClient.getEndpoints = function () {
        return BaseClient_1.default.constructEndpoints(InfernoClient.TOKEN_ENDPOINT, InfernoClient.R4_ENDPOINT, InfernoClient.AUTHORIZE_ENDPOINT);
    };
    InfernoClient.prototype.getEndpoints = function () {
        return InfernoClient.getEndpoints();
    };
    InfernoClient.prototype.create = function (resource, patientId, encounterId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, _super.prototype.create.call(this, resource, patientId, encounterId, this.createHeaders({}))];
            });
        });
    };
